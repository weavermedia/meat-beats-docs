...
"**Product**" means the Meat Beats digital product you obtain under this Agreement.

"**Software**" means any executable software included in the Product, such as plugins or standalone applications.

"**Content**" means all non-software assets included in the Product, including presets, samples, impulse responses, wavetables, MIDI files, graphics and other assets.

"**Output**" means the audio, music or other creative works you create using the Product.
...
- Resell, redistribute, rent, lease or share the Product, Software or Content
- Make the Product, Software or Content available on file-sharing platforms
- Use the Content, whether modified or unmodified, to create competing commercial products, including sample packs, preset packs, sound libraries or similar products
- Reverse engineer, decompile, disassemble or modify the Software
- Remove or alter any proprietary notices

In short: make anything you like with the tools, but don't redistribute the Product itself, or any of its Content in a form that competes with the original.

## 5. No warranty

I work hard to make the Product great, but it's provided "as is", without warranty of any kind, express or implied. Use it at your own risk.
